...
// # Crear una función que busque un alumno por Nombre o Apellido.
...
var name = prompt('Ingresa un nombre o un apellido')
searchStudentByNameOrLastName(name)




function searchStudentByNameOrLastName(studentName) {
  for (var i = 0; i < students.length; i++) {
    var student = students[i]
    if (student.firstName === studentName || student.lastName === studentName) {
